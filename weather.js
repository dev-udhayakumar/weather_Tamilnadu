function places(){
    ...
    select.setAttribute('style','width: 100%;height: 45px;margin-top: 10px;background-color: rgb(255, 255, 255);border-color: rgb(228, 228, 228);font-weight: bolder;font-size: 16px;transition-duration: 0.4s;border-radius: 6px;');
